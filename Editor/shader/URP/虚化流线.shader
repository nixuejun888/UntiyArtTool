...
Shader "ni/Universal/虚化流线"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _jianbianyanse;
			float4 _xiantiaoyanse;
			float _zhouxiang;
			float _fangxiangqiehuan;
			float _xiantiaoduanshu;
			float _xiantiaoliudongsudu;
			float _xiantiaokuandu;
			float _jianbianfanwei1;
			float _zhengtitoumingdu;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord3 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult6 = lerp( texCoord3.x , texCoord3.y , _zhouxiang);
				float lerpResult147 = lerp( lerpResult6 , ( 1.0 - lerpResult6 ) , _fangxiangqiehuan);
				float mulTime14 = _TimeParameters.x * _xiantiaoliudongsudu;
				
				float3 Albedo = _jianbianyanse.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( _xiantiaoyanse * pow( ( abs( ( frac( ( ( lerpResult147 * _xiantiaoduanshu ) + mulTime14 ) ) - 0.5 ) ) * 2.0 ) , _xiantiaokuandu ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( saturate( (-_jianbianfanwei1 + (lerpResult147 - 0.0) * (1.0 - -_jianbianfanwei1) / (1.0 - 0.0)) ) * _zhengtitoumingdu );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( saturate( (-_jianbianfanwei1 + (lerpResult147 - 0.0) * (1.0 - -_jianbianfanwei1) / (1.0 - 0.0)) ) * _zhengtitoumingdu );
...
/*ASEBEGIN
Version=18935
7;36;1920;983;-2329.479;938.964;1;True;True
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;3277.365,-222.1369;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;39;3088.257,-587.1404;Inherit;False;Property;_jianbianyanse;渐变颜色;2;1;[HDR];Create;False;0;0;0;False;0;False;0.3101193,0.5698268,0.9528302,1;0,0.9551587,7.601456,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;48;2751.295,-64.08863;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
WireConnection;159;0;39;0
WireConnection;159;2;48;0
WireConnection;159;6;50;0
ASEEND*/
//CHKSM=AFFBEECF89E3201C63412AC65B6E77B6C2854E7A