...
热力图脚本挂shader给予的物体上，加碰撞体（要用plane类型的碰撞体），触发物体加碰撞体和刚体.
...
<root>
  ...
  ├── Editor
  │   ├── Undefined.Vtronsoftshader.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Undefined.Vtronsoftshader.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Undefined.Vtronsoftshader.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Undefined.Vtronsoftshader.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Undefined.Vtronsoftshader`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package VtronSoftShader Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Undefined.Vtronsoftshader.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Undefined.Vtronsoftshader.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Undefined.Vtronsoftshader.Editor.Tests.asmdef`

  `Tests/Runtime/Undefined.Vtronsoftshader.Tests.asmdef`
...
Use the `Documentations~/VtronSoftShader.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
